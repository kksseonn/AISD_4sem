...
int main() {
    ...
    std::cout << "Time taken to fill BinarySearchTree: "
    ...
    std::cout << "Time taken to search in BinarySearchTree: "
        << static_cast<double>(end_bst_time - start_bst_time) / CLOCKS_PER_SEC / num_iterations
        << " seconds" << std::endl;
    ...
    end_bst_time = std::clock();
    std::cout << "Time taken to insert and erase in BinarySearchTree: "
        << static_cast<double>(end_bst_time - start_bst_time) / CLOCKS_PER_SEC / num_iterations
        << " seconds" << std::endl;
